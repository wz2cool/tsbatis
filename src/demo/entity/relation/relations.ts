...
export class Relations {
  ...
  public static getCustomer_OrderRelation(): CollectionRelation<Customer, Order> {
    const statusFilter = new FilterDescriptor<Order>({ propertyPath: "statusId", operator: FilterOperator.EQUAL, value: 3 });
    const dynamicQuery = new DynamicQuery<Order>().addFilters([statusFilter]);
