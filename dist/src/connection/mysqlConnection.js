...
var MysqlConnection = (function () {
    function MysqlConnection(connection, enableLog) {
        if (enableLog === void 0) { enableLog = false; }
        this.connection = connection;
        this.enableLog = enableLog;
    }
    MysqlConnection.prototype.getDataBaseType = function () {
        return model_1.DatabaseType.MYSQL;
    };
    MysqlConnection.prototype.getRowBoundsExpression = function (rowBounds) {
        var offset = rowBounds.offset;
        var limit = rowBounds.limit;
        return "limit " + offset + ", " + limit;
    };
    MysqlConnection.prototype.run = function (sql, params) {
        var _this = this;
        this.log("run:\r\nsql: " + sql + "\r\nparams: " + params);
    ...
    MysqlConnection.prototype.select = function (sql, params) {
        var _this = this;
        this.log("select:\r\nsql: " + sql + "\r\nparams: " + params);
        return new Promise(function (resolve, reject) {
            _this.connection.query(sql, params, function (err, result) {
    ...
    MysqlConnection.prototype.selectCount = function (sql, params) {
        var _this = this;
    ...
    MysqlConnection.prototype.selectEntities = function (entityClass, sql, params) {
        var _this = this;
    ...
    MysqlConnection.prototype.rollbackAndRelease = function () {
    ...
    MysqlConnection.prototype.commitAndRelease = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MysqlConnection.prototype.log = function (log) {
