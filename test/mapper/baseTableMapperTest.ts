...
describe(".baseTableMapper", () => {
  ...
  describe("#insertSelective", () => {
    it("insertSelectiveWithAutoIncreaseTest successfully", done => {
      helper
        .insertSelectiveWithAutoIncreaseTest()
        .then(() => {
          done();
        })
        .catch(err => {
  ...
  describe("#updateSelectiveByPrimaryKey", () => {
    it("updateSelectiveByPrimaryKey successfully", done => {
      helper
        .updateSelectiveByPrimaryKeyTest()
        .then(() => {
          done();
        })
        .catch(err => {
  ...
  describe("#mybatisSelectEntitiesRowBounds", () => {
    it("mybatisSelectEntitiesRowBounds successfully", done => {
      helper
        .mybatisSelectEntitiesRowBoundsTest()
        .then(() => {
          done();
        })
        .catch(err => {
